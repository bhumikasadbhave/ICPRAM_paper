...
\author{
    ...
    \email{bhumikalaxman.sadbhave@study.thws.de, philipp.vaeth@thws.de, dejon@greenspin.de, schorcht@greenspin.de, magda.gregorova@thws.de}
}
...
\begin{figure}[t]
    \centering
    \includegraphics[scale=0.5]{data_repr.png}
